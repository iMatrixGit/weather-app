...
import { clearCityData, consumeCityData } from '../actions/city'
import { clearForecastData, consumeForecastData } from '../actions/forecast'
...
function * consumeReceivedData ({city, forecast}) {
  if (city && forecast) {
    ...
    yield put(clearCityData())
    yield put(clearForecastData())
  }
}
